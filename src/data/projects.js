...
import pandaSImage from '@/assets/projects/panda-s-preview.jpg'
import seattleUImage from '@/assets/SeattleU.png'
...
const projects = [
  {
    ...
    status: 'App Store',
    role: 'Co-developer',
    impact: 'Offline-first brew logging',
    summary:
      'A no-account coffee brewing logger for dialing in recipes with timers, local history, and swipe-first mobile interactions.',
    description:
  ...
  },
  {
    ...
    impact: 'Retro portfolio + arcade',
    summary:
      'A Vue single-page portfolio with scroll-snap sections, a terminal-inspired visual system, and embedded browser games.',
    description:
  ...
  },
  {
    ...
    impact: 'Automated trust-safety triage',
    summary:
      'A serverless AWS pipeline and React dashboard for surfacing safety topics, sentiment patterns, and trending customer concerns.',
    description:
    ...
    technologies: ['Python', 'React.js', 'JavaScript', 'AWS Lambda', 'Comprehend', 'DynamoDB'],
    image: seattleUImage
  },
  {
    ...
    status: 'Prototype',
    role: 'UX designer',
    impact: 'Local eatery discovery flows',
    summary:
      'A mobile food-discovery concept shaped through personas, information architecture, paper prototypes, and high-fidelity Figma screens.',
    description:
    ...
    technologies: ['Figma', 'User research', 'Interactive prototyping', 'Information architecture'],
  ...
  },
  {
    ...
    impact: 'Sustainable travel gamification',
    summary:
      'A Flutter app that rewards lower-carbon transit choices with route planning, challenges, leaderboards, and profile progression.',
    description:
  ...
  },
  {
    ...
    status: 'Prototype',
    role: 'Flutter developer',
    impact: 'Personal wellness tracking',
    summary:
      'A Flutter health tracker for logging meals, workouts, emotions, and gamified wellness progress across languages.',
    description:
  ...
  },
  {
    ...
    impact: 'Product catalog + cart flow',
    summary:
      'An Angular and Node e-commerce build with product browsing, cart state, authentication, orders, and MongoDB persistence.',
    description:
  ...
  },
  {
    ...
    status: 'CLI',
    role: 'C++ developer',
    impact: 'Unix process fundamentals',
    summary:
      'A Unix-like shell that parses commands, forks processes, wires pipes, and manages parent-child execution flow.',
    description:
    ...
    technologies: ['C++', 'fork', 'pipe', 'execvp', 'Process management'],
  ...
  },
  {
    ...
    status: 'CLI',
    role: 'C++ developer',
    impact: 'Hash-table data retrieval',
    summary:
      'A C++ data-management CLI backed by a custom hash table with separate chaining, date-based updates, and file I/O.',
    description:
    ...
    technologies: ['C++', 'STL vectors', 'File I/O', 'Hash table', 'OOP'],
  ...
  },
  {
    ...
    status: 'CLI',
    role: 'C++ developer',
    impact: 'API-driven quiz flow',
    summary:
      'A C++ trivia game that fetches questions from Open Trivia DB, randomizes choices, tracks score, and renders terminal feedback.',
    description:
    ...
    technologies: ['C++', 'CURL', 'JSON', 'STL vectors', 'OOP'],
